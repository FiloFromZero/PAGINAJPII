  ...
  return {
    ...
    hooks: {
      'astro:config:setup': async ({
        ...
        const buildLogger = logger.fork('jpii');

        const virtualModuleId = 'app:config';
        ...
        if (typeof _themeConfig === 'string') {
          ...
          buildLogger.info(`Config has been loaded.`);
        }
      },
