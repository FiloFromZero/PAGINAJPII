import { d as createAstro, c as createComponent, r as renderComponent, F as Fragment, a as renderTemplate, m as maybeRenderHead, b as addAttribute, s as spreadAttributes } from './astro/server_HJvi1lLk.mjs';
import 'kleur/colors';
import { f as findImage } from './images_CTrLM9yj.mjs';
...
const $$Image = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${!image ? renderTemplate`${renderComponent($$result, "Fragment", Fragment, {})}` : renderTemplate`${maybeRenderHead()}<img${addAttribute(image.src, "src")} crossorigin="anonymous" referrerpolicy="no-referrer"${addAttribute(`rounded-lg shadow-lg ${props.class?.includes("h-20") || props.class?.includes("max-h-12") ? "" : "animate-card-hover"} ${props.class || ""}`, "class")}${addAttribute(`image-rendering: -webkit-optimize-contrast; image-rendering: optimize-quality; ${image.attributes?.style || ""}`, "style")}${spreadAttributes(image.attributes)}>`}`;
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/common/Image.astro", void 0);

const $$Logo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div> ${renderComponent($$result, "Image", $$Image, { "class": "object-none h-20", "src": "~/assets/images/logo.png", "alt": "Logo" })} </div>`;
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/Logo.astro", void 0);
