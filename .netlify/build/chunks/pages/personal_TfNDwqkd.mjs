import { d as createAstro, e as createComponent, m as maybeRenderHead, g as addAttribute, i as renderComponent, r as renderTemplate, u as unescapeHTML, j as Fragment, A as AstroError, n as UnknownContentCollectionError, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent } from '../astro_CfJRq3Yt.mjs';
import 'kleur/colors';
import { d as $$Icon, a as $$Image, $ as $$Button, b as $$PageLayout, c as $$Header } from './admisiones_DsFyNX6Q.mjs';
import { $ as $$Hero } from './lead-generation_DrrgmZlO.mjs';
import { a as $$Content, c as $$Testimonials } from './index_BGd6N1Nt.mjs';
import { $ as $$WidgetWrapper, a as $$Headline, d as $$CallToAction } from './click-through_D7_kWT5P.mjs';
import { $ as $$Features3 } from './mobile-app_BeLoa1d1.mjs';
import { twMerge } from 'tailwind-merge';
import { f as findImage, c as getPermalink, A as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE, e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, h as getBlogPermalink } from './404_Dw-3UrCo.mjs';
...
const $$Timeline = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${items && items.length && renderTemplate`${maybeRenderHead()}<div${addAttribute(containerClass, "class")}>${items.map(({ title, description, icon, classes: itemClasses = {} }, index = 0) => renderTemplate`<div${addAttribute(twMerge("flex", panelClass, itemClasses?.panel), "class")}><div class="flex flex-col items-center mr-4 rtl:mr-0 rtl:ml-4"><div><div class="flex items-center justify-center">${(icon || defaultIcon) && renderTemplate`${renderComponent($$result, "Icon", $$Icon, { "name": icon || defaultIcon, "class": twMerge("w-10 h-10 p-2 rounded-full border-2", defaultIconClass, itemClasses?.icon) })}`}</div></div>${index !== items.length - 1 && renderTemplate`<div class="w-px h-full bg-black/10 dark:bg-slate-400/50"></div>`}</div><div${addAttribute(`pt-1 ${index !== items.length - 1 ? "pb-8" : ""}`, "class")}>${title && renderTemplate`<p${addAttribute(twMerge("text-xl font-bold animate-text-hover", titleClass, itemClasses?.title), "class")}>${unescapeHTML(title)}</p>`}${description && renderTemplate`<p${addAttribute(twMerge("text-muted mt-2 animate-text-hover", descriptionClass, itemClasses?.description), "class")}>${unescapeHTML(description)}</p>`}</div></div>`)}</div>`}`;
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/ui/Timeline.astro", void 0);
...
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/widgets/Steps.astro", void 0);
...
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/blog/Grid.astro", void 0);

const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://iejuanpabloiisoacha.edu.co", "SSR": true};
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/post/astrowind-template-in-depth.mdx": () => import('../astrowind-template-in-depth_I-6oixAu.mjs'),"/src/content/post/get-started-website-with-astro-tailwind-css.md": () => import('../get-started-website-with-astro-tailwind-css_SiYLek2Z.mjs'),"/src/content/post/how-to-customize-astrowind-to-your-brand.md": () => import('../how-to-customize-astrowind-to-your-brand_DtbobaPk.mjs'),"/src/content/post/landing.md": () => import('../landing_rfWE7vz2.mjs'),"/src/content/post/markdown-elements-demo-post.mdx": () => import('../markdown-elements-demo-post_C34QA3KO.mjs'),"/src/content/post/useful-resources-to-create-websites.md": () => import('../useful-resources-to-create-websites_7d3-aOcP.mjs')});
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/post/astrowind-template-in-depth.mdx": () => import('../astrowind-template-in-depth_BlIAIxYc.mjs'),"/src/content/post/get-started-website-with-astro-tailwind-css.md": () => import('../get-started-website-with-astro-tailwind-css_BTErSGbI.mjs'),"/src/content/post/how-to-customize-astrowind-to-your-brand.md": () => import('../how-to-customize-astrowind-to-your-brand_phVb4E7V.mjs'),"/src/content/post/landing.md": () => import('../landing_-im2j4Gv.mjs'),"/src/content/post/markdown-elements-demo-post.mdx": () => import('../markdown-elements-demo-post_DxPJkCh5.mjs'),"/src/content/post/useful-resources-to-create-websites.md": () => import('../useful-resources-to-create-websites_CHj4FjUp.mjs')});
...
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/components/widgets/BlogLatestPosts.astro", void 0);
...
}, "C:/Users/user/Desktop/JUANPABLO/P\xC1GINA WEB/Colegio_JPII/src/pages/homes/personal.astro", void 0);

const $$file = "C:/Users/user/Desktop/JUANPABLO/PÁGINA WEB/Colegio_JPII/src/pages/homes/personal.astro";
...
export { $$BlogLatestPosts as $, getStaticPathsBlogTag as a, blogCategoryRobots as b, blogTagRobots as c, getStaticPathsBlogList as d, blogListRobots as e, fetchPosts as f, getStaticPathsBlogCategory as g, findPostsByIds as h, $$Grid as i, getRelatedPosts as j, getStaticPathsBlogPost as k, blogPostRobots as l, personal as p };
